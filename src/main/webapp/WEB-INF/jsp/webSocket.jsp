...
<head>
    ...
    <script src="/resources/script/sockjs-1.1.1.js" type="text/javascript"></script>
    ...
    <script type="text/javascript">
        ...
        function connect() {
            ...
            //ws = new SockJS("http://192.168.0.134:8080/ws/sockjs");
...
<div>
    <div id="connect-container">
        ...
        <br>
        <input id="radio2" type="radio" name="group1" onclick="updateUrl('/ws/sockjs');">
