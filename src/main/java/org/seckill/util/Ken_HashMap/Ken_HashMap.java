package org.seckill.util.Ken_HashMap;

/**
 * Created by Ken Pan on 2017/6/15.
 */
public class Ken_HashMap<K, V> {
    ...
    public Ken_HashMap(int capacity) {
        if (capacity <= 0) {
    ...
    public static void main(String[] args) {
        Ken_HashMap<String, String> map = new Ken_HashMap<String, String>();
        map.put("001", "James");
        map.put("002", "Antony");
        map.put("003", "Bosh");
        map.put("004", "Wade");
